  ...
  Future<void> _applyChanges() async {
    ...
    try {
      ...
      for (final consoleId in supportedConsoles) {
        final gamesListRaw = await allGamesRepo.getGameList(
          consoleId.toString(),
          apiKey,
          useCache: true,
        );
        if (gamesListRaw != null) {
          ...
          await localDataRepo.saveConsoleTotals(
            consoleId,
            totalGames,
            totalHashes,
          );
          ...
          await localDataRepo.saveHashStats(
            consoleId,
            matchedGames,
            matchedHashes,
          );
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            CheckboxListTile(
              ...
              onChanged: (value) {
                if (value != null) {
                  ref.read(settingsProvider.notifier).setIgnoreHack(value);
                }
              },
            ),
            // Homebrew
            CheckboxListTile(
              ...
              onChanged: (value) {
                if (value != null) {
                  ref.read(settingsProvider.notifier).setIgnoreHomebrew(value);
                }
              },
            ),
            // Prototype
            CheckboxListTile(
              ...
              onChanged: (value) {
                if (value != null) {
                  ref.read(settingsProvider.notifier).setIgnorePrototype(value);
                }
              },
            ),
            // Unlicensed
            ...
            CheckboxListTile(
              ...
              onChanged: (value) {
                if (value != null) {
                  ref.read(settingsProvider.notifier).setIgnoreDemo(value);
                }
              },
            ),
            // Subset
            CheckboxListTile(
              ...
              onChanged: (value) {
                if (value != null) {
                  ref.read(settingsProvider.notifier).setIgnoreSubset(value);
                }
              },
            ),
