...
final consoleFoldersProvider = FutureProvider<Map<int, List<String>>>((
  ref,
) async {
...
class ConsoleStatsNotifier
    extends StateNotifier<Map<int, Map<String, dynamic>>> {
...
final consoleStatsNotifierProvider =
    StateNotifierProvider<ConsoleStatsNotifier, Map<int, Map<String, dynamic>>>(
      (ref) {
        final repository = ref.watch(localDataRepositoryProvider);
